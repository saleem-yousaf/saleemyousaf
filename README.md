...
- Secure AWS and Azure architecture · landing zones, governance, identity design
- Zero Trust · real implementation using Zscaler, network segmentation, assume-breach design
- Threat modelling · STRIDE and MITRE ATT&CK driven design
- Breach and Attack Simulation · built and delivered BAS end-to-end, Cymulate, Rapid7
...
I write regularly about cloud security, AI governance, Zero Trust, and OT security.

- Personal site and articles: [saleemyousaf.co.uk](https://www.saleemyousaf.co.uk)
- Medium: [saleemyousaf.medium.com](https://saleemyousaf.medium.com)
- DEV.to: [dev.to/saleem_yousaf](https://dev.to/saleem_yousaf)
- Hashnode: [hashnode.com/@saleemyousaf](https://hashnode.com/@saleemyousaf)

---

## Technologies

AWS · Azure · GCP · Terraform · Kubernetes · Zscaler · Wiz · Microsoft Sentinel · Microsoft Defender · Cymulate · Rapid7 · Amazon Bedrock · GitHub Actions · CI/CD · SIEM
